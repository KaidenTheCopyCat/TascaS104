...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * descripció del possible mismatch (desajustament).
		 * 
		 * L'únic mètode que hem de sobreescriure és featureValueOf (T actual), que
		 * retorna el valor que es passarà al mètode match () / matchesSafely ().
		 * Utilitza el seu comparador personalitzat en una prova per a comprovar si la
		 * cadena "Mordor" té una longitud de 8.
		 * 
